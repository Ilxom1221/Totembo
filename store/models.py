...
class Category(models.Model):
    ...
    def get_image(self):
        if self.image:
            ...
            return 'https://www.autoglushitel.com/wp-content/uploads/2018/12/13124-600x600.jpg'
...
class Order(models.Model):
    customer = models.ForeignKey(Customer, on_delete=models.SET_NULL, blank=True, null=True, verbose_name='Имя покупателя')
